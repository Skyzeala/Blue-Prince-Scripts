...
picture_list = [
    ...
    ["plant", "flower", "herb", "greenery", "flora", "vegetable", "bloom", "sage", "basil", 
     "oregano", "thyme", "flowers", "leaves", "leaf", "iris"],
    ...
    ["spine", "bone", "vertebrae", "spinal", "back", "backbone", "skeleton"],
    ...
    ["tube", "liquid", "vial", "potion", "flask", "tincture", "test", "beaker", "elixir",
     "tonic", "acid", "reagent", "science", "bottle", "mixture", "sample", "poison", "chemical"],
    ...
    ["dessert", "flan", "jello", "pudding", "spoon", "plate", "custard", "platter", "saucer",
     "dish"],
    ["comb", "groom", "brush"],
    ["bear", "teddy", "plush", "stuffed", "cuddly", "toy"],
    ["shoe", "clog", "loafer", "slipper", "sneaker", "heel", "sole", "foot", "footwear", "sabot"],
    ["boat", "rowboat", "row", "canoe", "raft", "paddle", "oar", "paddleboat", "cruise", "ferry", 
     "dinghy", "dory"],
    ["and", "&", "also", "too", "with", "plus", "ampersand", "symbol"],
    ["cot", "bed", "hammock", "sleep", "rest", "bunk"],
    ...
    ["red", "p", "stop", "sign", "stopsign", "rose", "fire", "hydrant", "mirror", "reverse",
     ...
     "this puzzle has hints and solutions in-game", "p on top of red items", "red is mirrored"],
    ...
    ["cane", "hook", "crook", "stick", "staff", "crutch", "pole"],
    ["chess", "rook", "castle", "piece", "chariot"],
    ["harp", "string", "instrument", "lyre", "musical"],
    ["gear", "cog", "pinion", "sprocket", "wheel"],
    ["pie", "crust", "dessert", "pastry", "tart", "quiche", "slice"],
    ["boxers", "boxing", "martial", "martial arts", "kick", "spar", "box", "boxer", "duel",
     "combat", "brawl", "fight", "strike", "judo", "wrestle", "guard", "counter", "karate"],
    ["pliers", "plier", "ply", "gripper", "tongs", "clamp", "grip", "tool", "pincers", "plyers"],
    ["pi", "three", "3.14", "circle", "math", "symbol", "greek", "ratio", "archimedes' constant"],
    ["leash", "lead", "tether", "rope", "cord", "strap", "halter"],
    ["planet", "globe", "create", "art", "world", "paint", "brush", "hand", "earth", "realm",
     "sphere", "ball", "orb", "earth art", "compass", "coordinate", "position"],
    ["eye", "eyelash", "lash", "eyeball", "optic", "see", "observe", "view", "gaze", "stare",
     "peek", "look", "sight", "watch", "eyelid", "mascara", "cornea", "pupil", "iris", "lens"],
    ["snail", "slow", "going", "forward", "slug", "spiral", "shell", "mollusk"],
    ["arm", "elbow", "hand", "armpit", "pit", "fist", "punch", "limb", "shoulder", "forearm"],
    ...
    ["book", "author", "novel", "story", "diary", "journal", "volume", "tome", "title", "chapter",
     "mary", "bible", "holy", "spine", "guide", "work", "album", "tale", "chronicle", "fable"],
    ["christmas", "tree", "noel", "merry", "yule", "advent", "holiday", "gift", "present",
     "presents", "pine", "ornament", "december", "25", "star", "festive", "winter", "joy"],
    ["seed", "sprout", "sprouted", "plant", "root", "germ", "germinate", "grow", "growth", "sow"],
    ["shoelace", "end", "aglet", "lace", "strap", "string", "cord", "tie", "knot"],
    ["calendar", "year", "month", "day", "date", "tear", "eight", "8", "schedule", "agenda", "plan",
     "anniversary", "time", "age", "epoch", "era", "8th", "paper", "daily"],
    ["ear", "lobe", "hear", "sound", "noise", "earlobe"],
    ["steam", "pot", "boil", "stock", "soup", "burn", "cook", "stock", "pan", "cauldron", "kettle"],
    ...
    ["music", "note", "song", "tune", "bar", "melody", "sheet", "score", "compose", "stave",
     ...
     "requiem", "tempo", "measure", "4", "four", "clef"],
    ["pin", "bowling", "bowl", "skittle", "kegel", "club", "ninepin", "tenpin", "duckpin", "knock",
     "fall", "topple", "strike", "spare", "down"],
    ["win", "medal", "one", "1", "1st place", "place", "first", "victory", "award", "champion",
     "champ", "gold", "victor", "winner", "prize", "top"],
    ["boar", "pig", "hog", "sow", "swine", "ham", "pork", "bacon"],
    ["farm", "ranch", "barn", "field", "range", "grange", "farmhouse", "farmland", "plantation",
     "orchard", "vinyard", "cropland", "crop", "crops", "pasture", "till", "agriculture", "land",
     "country", "countryside", "shed", "stable"],
    ["tin", "can", "open", "tab", "empty", "aluminum", "jar", "package", "pull", "lid",
     "ring", "pop", "top", "opener", "rim", "handle"],
    ["fountain", "pen", "ink", "calligraphy", "write", "reservoir", "marker", "nib", "lid", "cap"],
    ["wine", "liquor", "alcohol", "bottle", "cork", "booze", "juice", "drink", "sake", "rum"],
    ["lunch", "box", "lunchbox", "tin", "meal", "suitcase", "case", "metal", "pail", "bento",
     "briefcase", "satchel", "case"],
    ["lab", "laboratory", "chemistry", "experiment", "test", "testing", "research", "science",
     "alchemy", "distill", "flask", "chemicals", "microscope", "vial"],
    ["lamb", "sheep", "calf", "colt", "ewe", "ram", "hoof", "foot", "ear", "horn", "horns"],
    ["rat", "mouse", "rodent", "vermin", "varmint", "gnawer", "hamster"],
    ["tarot", "moon", "card", "the moon", "eclipse", "crescent", "xviii", "18", "rogue"],
    ["bait", "worm", "fishing bait", "chum", "lure", "earthworm", "wiggler", "compost"], 
    ["thorn", "stem", "vine", "rose", "spike", "barb", "branch", "spiny", "thorny", "spine", 
     "spiky", "bristle", "prick", "prickle", "climb", "creep", "trail", "ivy", "plant", "stalk"],
    ["horse", "mustang", "stallion", "gallop", "trot", "canter", "run", "speed", "steed", 
     "racehorse", "bronco", "pony", "mount", "equine", "race", "hoof"],
    ["weight", "weigh", "three", "3", "kettlebell", "dumbbell", "lift", "girya", "carry",
     "balance", "heft", "heave", "heavy", "mass", "power", "muscle"],
    ["corn", "corncob", "cob", "maize", "ear", "elote", "mealie", "kernel"],
